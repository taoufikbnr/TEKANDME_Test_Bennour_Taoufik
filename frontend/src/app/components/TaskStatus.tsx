...
const TaskStatus = () => {
    ...
    return (
        <div className='flex flex-col md:flex-row md:items-center justify-between gap-2 w-full mb-4'>
            ...
            <div className='bg-orange-200 font-bold rounded-4xl p-4 w-full md:w-[150px] h-[100px] md:h-[150px]'>
            ...
            <div className='bg-red-100 font-bold rounded-4xl p-4 w-full md:w-[150px] h-[100px] md:h-[150px]'>
                <h1 className='flex flex-col items-center p-4 text-center'>
        ...
        <div className='flex flex-col md:flex-2 items-center justify-center text-center shadow-2xl rounded-3xl h-full'>
